...
function DynamicFrameLayoutContainer({ children, className, fullWidth = false }: DynamicFrameLayoutProps) {
  return <div className={cn("w-full", fullWidth ? "" : "container", className)}>{children}</div>
}
